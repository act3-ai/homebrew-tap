...
class Act3Pt < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "reg.git.act3-ace.com/devsecops/act3-pt/releases/act3-pt@sha256:3323e647964794340fa48571f425e0f7fb104de962fdca7320b2356fb99c6656",
          using: BlobDownloadStrategy
      sha256 "3323e647964794340fa48571f425e0f7fb104de962fdca7320b2356fb99c6656"
    end
    if Hardware::CPU.arm?
      url "reg.git.act3-ace.com/devsecops/act3-pt/releases/act3-pt@sha256:639c279a6a5e89ed4211b8707a19230a2b7b2a0496e3e661b35b07cf469efd1f",
          using: BlobDownloadStrategy
      sha256 "639c279a6a5e89ed4211b8707a19230a2b7b2a0496e3e661b35b07cf469efd1f"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "reg.git.act3-ace.com/devsecops/act3-pt/releases/act3-pt@sha256:4d9e927c22bd9d46578c435bb01669d4b9ca957fe036616cdb055c7ab1eacbdd",
          using: BlobDownloadStrategy
      sha256 "4d9e927c22bd9d46578c435bb01669d4b9ca957fe036616cdb055c7ab1eacbdd"
    end
    if Hardware::CPU.intel?
      url "reg.git.act3-ace.com/devsecops/act3-pt/releases/act3-pt@sha256:fbabc3a1392673c2f567f53b5be3a98f255b9300e5af5e0aeff76d41952fdbee",
          using: BlobDownloadStrategy
      sha256 "fbabc3a1392673c2f567f53b5be3a98f255b9300e5af5e0aeff76d41952fdbee"
    end
  end
